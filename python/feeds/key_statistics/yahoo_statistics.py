...
class YahooStatistics (scraper.WebScraper):
	def __init__(self, symbol):
		params = urllib.urlencode({'p': symbol})
		url = "https://uk.finance.yahoo.com/quote/{0}/key-statistics?%s".format(symbol) % params
	...
	def register(self):
		self.register_xpath('enterprise_value', '//*[@id="main-0-Quote-Proxy"]/section/div[2]/section/div/section/div[2]/div[1]/div[1]/div/table/tbody/tr[2]/td[2]')
