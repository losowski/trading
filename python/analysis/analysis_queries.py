...
""",
	${relative_index} AS (
		...
		FROM
			symbol_absolute sq0
			INNER JOIN symbol_quote ${relative_index} ON (sq0.q_datestamp - '${days_interval}'::interval ${days_operator} ${relative_index}.q_datestamp  AND ${relative_index}.${field_name} ${operator} sq0.${field_name} + ${value})
	)"""
